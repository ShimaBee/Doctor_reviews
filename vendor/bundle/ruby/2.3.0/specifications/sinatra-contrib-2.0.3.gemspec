# -*- encoding: utf-8 -*-
# stub: sinatra-contrib 2.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.homepage = "http://www.sinatrarb.com/contrib/".freeze
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      s.add_runtime_dependency(%q<sinatra>.freeze, ["= 2.0.3"])
      s.add_runtime_dependency(%q<mustermann>.freeze, ["~> 1.0"])
      s.add_runtime_dependency(%q<backports>.freeze, [">= 2.8.2"])
      ...
      s.add_dependency(%q<backports>.freeze, [">= 2.8.2"])
